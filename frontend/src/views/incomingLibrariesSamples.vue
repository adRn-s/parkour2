        ...
        groupHeader: (value, count, data) => {
          ...
          return `
            ...
            count > 1 ? "s" : ""
                ...
                <div class="group-action-buttons-container" style="position: sticky; right: 0; gap: 3px;">
      ...
      this.columnsList = [
        {
          ...
          cellClick: function (e, cell) {
            ...
            if (rowData.selected) {
              ...
              let currentSelectedRows = this.currentSelectedRows.filter(
                (r) => r.id !== rowData.id
              );
            ...
            const selectedRows = clickedRow
              .getTable()
              .getRows()
              .filter((row) => row.getData().selected);
