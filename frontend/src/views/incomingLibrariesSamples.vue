    ...
    <div class="parent-container">
                ...
                <div class="button-popup-wrapper">
                    ...
                    <div v-if="showSelectColumns" class="button-popup-container" style="left: -48px">
                        <ul style="padding-left: 0px;">
                            <li v-for="(column, index) in columnsList.filter((column) => column.field !== 'select')"
                                :key="index">
                                <label>
        ...
        <div class="table-container">
            <div style="margin: 10px; border: 1px solid lightgray">
                <TabulatorTable v-if="!loading" :rowData="filteredLibrariesSamples" :columnDefs="currentVisibleColumns"
...
export default {
        ...
        return {
            ...
            tableOptions: {
                ...
                `;
                    ...
                    <span style="font-weight: normal; font-size: 12px;">(${count} item${count > 1 ? 's' : ''}, Total Depth: ${totalDepth}M)</span>
                `;
                },
                    ...
                    },
                    {
                        ...
                        action: async function (e, group) {
                            try {
                                ...
                                const request_id = group.getRows()[0].getData();
                                const response = await axiosRef.post(`${urlStringStart}/api/requests/` + request_id + `/sample_submitted/`, payload);
                                showNotification("Marked as Sample Submitted", "success");
                            } catch (error) {
                                console.log(error)
                                handleError(error);
                            }
                ...
                rowContextMenu: [
                    ...
                    {
                        label: "Quality Check: Compromised",
                        action: function (e, row) {
    ...
    computed: {
        ...
        filteredLibrariesSamples() {
            console.log("changed", this.filteredLibrariesSamples)
    ...
    methods: {
        ...
        async getLibraryProtocols() {
            try {
                let response = await axiosRef.get(urlStringStart + "/api/library_protocols/");
            ...
            this.columnsList = [
                {
                    ...
                    formatter: function (cell) {
                        ...
                        const checkbox = `<input type="checkbox" ${rowData.selected ? "checked" : ""} />`;
                    ...
                    cellClick: function (e, cell) {
                        ...
                        // } else {
                        //     this.currentSelectedRows = this.currentSelectedRows.filter(r => r.id !== rowData.id);
                        // }
                ...
                ,
                { title: "Name", field: "name", minWidth: 150, width: "20%", headerFilter: true, visible: true, frozen: true, cssClass: "details-column disable-range-selection" },
                { title: "Barcode", field: "barcode", minWidth: 120, width: "12%", headerFilter: true, visible: true, cssClass: "details-column disable-range-selection" },
                {
                    title: "From Users", headerHozAlign: "left", vertAlign: "bottom", visible: true, columns: [
                        { title: "Input Type", field: "nucleic_acid_type_name", minWidth: 120, width: "7.95%", headerVertical: true, visible: true, vertAlign: "bottom", cssClass: "user-entry-column" },
                        { title: "Protocol", field: "library_protocol_name", minWidth: 120, width: "7.95%", headerVertical: true, visible: true, vertAlign: "bottom", cssClass: "user-entry-column" },
                        { title: "Comment Library/Input", field: "comments", minWidth: 120, width: "7.95%", headerVertical: true, visible: true, vertAlign: "bottom", cssClass: "user-entry-column" },
                        { title: "Input", field: "input", minWidth: 120, width: "7.95%", headerVertical: true, visible: true, vertAlign: "bottom", cssClass: "user-entry-column" },
                        {
                            title: "Volume", field: "volume", minWidth: 120, width: "7.95%", headerVertical: true, visible: true, vertAlign: "bottom", cssClass: "user-entry-column", formatter: function (cell) {
                        ...
                        {
                            title: "Size", field: "mean_fragment_size", minWidth: 120, width: "7.95%", headerVertical: true, visible: true, vertAlign: "bottom", cssClass: "user-entry-column", formatter: function (cell) {
                                let value = cell.getValue();
                                if (value === null || value === undefined) {
                                    return "-";
                                }
                ...
                },
                {
                    title: "From Facility", headerHozAlign: "left", vertAlign: "bottom", visible: true, columns: [
                        {
                            title: "Measuring Unit", field: "measuring_unit_facility", minWidth: 120, width: "7.95%", editor: "list", editorParams: {
                                values: [
                                    { label: "ng/µl (Concentration)", value: "concentration" },
                                    { label: "M (Cells)", value: "m" },
                                    { label: "Unknown", value: "-" }
                                ]
                            }, headerVertical: true, visible: true, vertAlign: "bottom", cssClass: "facility-entry-column", formatter: function (cell) {
                        ...
                        {
                            title: "Measured Value", field: "measured_value_facility", minWidth: 120, width: "7.95%", editor: "number", headerVertical: true, visible: true, vertAlign: "bottom", cssClass: "facility-entry-column", formatter: function (cell) {
                                let value = cell.getValue();
                                if (value === null || value === undefined) {
                                    return "-";
                                }
                        ...
                        {
                            title: "Volume", field: "sample_volume_facility", minWidth: 120, width: "7.95%", editor: "number", headerVertical: true, visible: true, vertAlign: "bottom", cssClass: "facility-entry-column", formatter: function (cell) {
                                let value = cell.getValue();
                                if (value === null || value === undefined) {
                                    return "-";
                                }
                        ...
                        {
                            title: "Size", field: "size_distribution_facility", minWidth: 120, width: "7.95%", editor: "number", headerVertical: true, visible: true, vertAlign: "bottom", cssClass: "facility-entry-column", formatter: function (cell) {
                                let value = cell.getValue();
                                if (value === null || value === undefined) {
                                    return "-";
                                }
                        ...
                        {
                            title: "RQN", field: "rna_quality", minWidth: 80, width: "5.30%", editor: "number", headerVertical: true, visible: true, vertAlign: "bottom", cssClass: "facility-entry-column", formatter: function (cell) {
                                let value = cell.getValue();
                                if (value === null || value === undefined) {
                                    return "-";
                                }
                        ...
                        {
                            title: "GMO Documentation", field: "gmo", minWidth: 80, width: "5.30%", editor: "list", editorParams: {
                                values: [
                                    { label: "Not Needed", value: "false" },
                                    { label: "Risk Assessment Done", value: "true" }
                                ]
                            }, headerFilter: false, headerVertical: true, visible: true, vertAlign: "bottom", cssClass: "facility-entry-column", formatter: function (cell) {
                                const value = cell.getValue();
                                const options = {
                                    "false": "Not Needed",
                        ...
                        { title: "Comment", field: "comments_facility", minWidth: 80, width: "5.30%", editor: "input", headerVertical: true, visible: true, vertAlign: "bottom", cssClass: "facility-entry-column" },]
                }
            ];
        },
        ...
        onSearch() {
            ...
            let searchedLibrariesSamplesList = [];
            searchedLibrariesSamplesList = this.librariesSamplesList.filter(row =>
                lowercasedQuery !== "" &&
                row.name.toLowerCase().includes(lowercasedQuery) ||
                row.barcode.toLowerCase().includes(lowercasedQuery)
            );
            this.filteredLibrariesSamples = searchedLibrariesSamplesList;
            console.log(this.filteredLibrariesSamples)
        },
        async onCellValueChanged(rowData, updatedData) {
            try {
                ...
                const response = await axiosRef.post(`${urlStringStart}/api/incoming_libraries/edit/`, payload);
